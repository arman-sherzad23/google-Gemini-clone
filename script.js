...
const GOOGLE_API_KEY = "AIzaSyAiTA7WopGqhp4TMJtZXnPyWw5LK_dBGuw";
    ...
    savedConversations.forEach(conversation => {
        ...
        const userMessageHtml = `
            ...
            <div class="message__content">
                <img class="message__avatar" src="sabaarman.png" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="Ask (1).png" alt="AskGPT avatar">
